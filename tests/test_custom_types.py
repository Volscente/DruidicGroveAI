...
@pytest.mark.parametrize("name, value", [("test_name", "test_value")])
def test_bigquery_query_parameter_exceptions(name: str, value: str) -> bool:
    """
    ...
    with pytest.raises(ValidationError):
        BigQueryQueryParameter(name=name, value=value)


@pytest.mark.parametrize(
    "query_path, query_parameters, local_path",
    [("test_query_path", ("test_name", "test_type", "test_value"), "test_local_path")],
)
def test_bigquery_query_config(
    query_path: str, query_parameters: Tuple[str, str, str], local_path: str
) -> bool:
    """
    ...
    bigquery_query_config = BigQueryQueryConfig(
